...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim training and conditioning with stroke technique coaching",
    ...
    "Drama Club": {
        "description": "Perform scenes, develop acting skills, and put on school productions",
        "schedule": "Thursdays, 3:30 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["charlotte@mergington.edu", "mason@mergington.edu"]
    },
    "Math Olympiad": {
        "description": "Practice advanced problem solving and compete in math contests",
